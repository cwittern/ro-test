...
![exist-db CI](https://github.com/cwittern/ro-test/workflows/exist-db%20CI/badge.svg)

<img src="icon.png" align="left" width="25%"/>

My amazing ro-test application
...
1.  Download  the `ro-test-1.0.0.xar` file from GitHub [releases](https://github.com/cwittern/ro-test/releases) page.

2.  Open the [dashboard](http://localhost:8080/exist/apps/dashboard/index.html) of your eXist-db instance and click on `package manager`.

    1.  Click on the `add package` symbol in the upper left corner and select the `.xar` file you just downloaded.

3.  You have successfully installed ro-test into exist.
...
If you see `BUILD SUCCESSFUL` ant has generated a `ro-test-1.0.0.xar` file in the `build/` folder. To install it, follow the instructions [above](#installation).
...
AGPL-3.0 © [Chris](http://wittern.org)
...
[release-url]: https://github.com/cwittern/ro-test/releases/latest
